...
Focuses on alert triage, noise reduction, and operational consistency. Applies high-volume yes/no/unknown decision-making principles to security alerts under incomplete data conditions. 
Istanbul-based (UTC+3). Remote. Full overlap with EU business hours; natural overlap with US overnight SOC operations across EST/CST/MST/PST windows.
